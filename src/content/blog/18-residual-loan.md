...
### Q: 残価設定ローンの利点は何ですか？
A: 月々の負担を抑えられます。また、新しい車に乗り換えやすいです。

### Q: 残価設定ローンのデメリットは何ですか？
A: 走行距離制限や傷の精算、残価割れリスクがあります。

### Q: 残価設定ローンはどんな人に適していますか？
A: 月々の支払いを抑えたい人や、3〜5年ごとに新しい車に乗り換えたい人に適しています。

### Q: 残価設定ローンの期間満了時に何をするか選択できますか？
A: はい、車を返却する、残価を一括返済して車を買い取る、残価を再ローンする、の3つから選択できます。
